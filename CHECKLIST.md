...
- **Active task:** Review the planar 2R forward-kinematics visualization specification before creating the consumer package.
...
- [ ] **Active:** Review the [planar 2R visualization specification](docs/02_spatial_kinematics/planar_2r_forward_kinematics_visualization.md), including its two models, static-first delivery, marker contract, animation bounds, failure behaviour, and headless acceptance checks.
